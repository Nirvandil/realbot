...
public class MatMatcher {
    ...
    private static final String pre = "(?:\\b|(?<=_))";
    ...
    MatMatcher() {
        ...
        pattern = Pattern.compile(sb.toString(), Pattern.CASE_INSENSITIVE + Pattern.UNICODE_CHARACTER_CLASS);
    }

    /**
     * Detects bad WORDS.
     * @param text text to analyze.
     * @return true if bad word was found.
     */
    ...
    /**
     * Replaces all bad symbols in given text.
     * @param text Text where to search and replace.
     * @param bip symbols for bad words.
     * @return modified text.
     */
    public String replace(String text, String bip) {
        return pattern.matcher(text).replaceAll(bip);
    }
}